#Question 1. Write a program to create barplots for all the categorical columns in mtcars.
...
#Question 2. Create a scatterplot matrix by gear types in mtcars dataset.
...
#Question 3. Write a program to create a plot density by class variable.

class(mtcars)

#plot density of mpg variable
d<- density(mtcars$mpg)
plot(d, main="mpg kernel density ")
polygon(d,col="green",border ="red")

#plot density of disp variable
c<- density(mtcars$disp)
plot(c, main="disp kernel density")
